...
part of 'search_retrofit_client.dart';
...
class _SearchRetrofitClient implements SearchRetrofitClient {
  _SearchRetrofitClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<ProductResponseDto> searchProduct(String query) async {
