...
part of 'address_retrofit_client.dart';
...
class _AddressRetrofitClient implements AddressRetrofitClient {
  _AddressRetrofitClient(this._dio, {this.baseUrl, this.errorLogger}) {
